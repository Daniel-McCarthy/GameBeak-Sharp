...
namespace GameBeak_Frontend
{
    public partial class AssemblyView : Form
    {
        ...
        private Tuple<string, int> disassembleAddress(short address)
        {
            ...
            byte opcode = Core.beakMemory.readMemory((ushort)address);
            string opcodeString = "";
            int bytesRead = 0;
                            ...
                            case 1:
                                {
                                    ...
                                    opcodeString = "01 " + argumentHex + " ld bc, " + argumentHex;
                                    bytesRead = 3;
                                    break;
                                }
                            case 2:
                                {
                                    short argument = (short)((Core.beakMemory.readMemory((ushort)(address + 1))) | (Core.beakMemory.readMemory((ushort)(address + 2)) << 8));
                                    string argumentHex = argument.ToString("X4");
                                    opcodeString = "02 " + argumentHex + " ld (bc), " + argumentHex;
                                    bytesRead = 3;
                                    break;
                                }
                            case 3:
                            ...
                            case 8:
                                {
                                    short argument = (short)((Core.beakMemory.readMemory((ushort)(address + 1))) | (Core.beakMemory.readMemory((ushort)(address + 2)) << 8));
                                    string argumentHex = argument.ToString("X4");
                                    opcodeString = "08 " + argumentHex + " ld (" + argumentHex + "), sp";
                                    bytesRead = 3;
                                    break;
                                }
                            case 9:
                            ...
                            case 0:
                                {
                                    short argument = Core.beakMemory.readMemory((ushort)(address + 1));
                                    string argumentHex = argument.ToString("X2");
                                    opcodeString = "10 " + argumentHex + " stop ";
                                    bytesRead = 2;
                                    break;
                                }
                            case 1:
                                {
                                    short argument = (short)((Core.beakMemory.readMemory((ushort)(address + 1))) | (Core.beakMemory.readMemory((ushort)(address + 2)) << 8));
                                    string argumentHex = argument.ToString("X4");
                                    opcodeString = "11 " + argumentHex + " ld de, " + argumentHex;
                                    bytesRead = 3;
                                    break;
                                }
                            case 2:
                            ...
                            case 8:
                                {
                                    ...
                                    string jumpAddress = ((char)argument + address + 2).ToString("X4");
                ...
                case 0x20:
                    {
                        switch (opcode & 0x0F)
                        {
                            ...
                            case 1:
                                {
                                    short argument = Core.beakMemory.readMemory((ushort)(address + 1));
                                    short argument2 = Core.beakMemory.readMemory((ushort)(address + 2));
                                    string byte1 = argument.ToString("X2");
                                    string byte2 = argument2.ToString("X2");
                            ...
                            case 0xE:
                                {
                                    short argument = Core.beakMemory.readMemory((ushort)(address + 1));
                                    string argumentHex = argument.ToString("X2");
                                    opcodeString = "2E " + argumentHex + " ld l, " + argumentHex;
                                    bytesRead = 2;
                                    break;
                                }
                            case 0xF:
                            ...
                            case 1:
                                {
                                    short argument = (short)((Core.beakMemory.readMemory((ushort)(address + 1))) | (Core.beakMemory.readMemory((ushort)(address + 2)) << 8));
                                    string argumentHex = argument.ToString("X4");
                                    opcodeString = "31 " + argumentHex + " ld sp, " + argumentHex;
                                    bytesRead = 3;
                                    break;
                                }
                            case 2:
                ...
                case 0xC0:
                    {
                        switch (opcode & 0x0F)
                        {
                            ...
                            case 0x06:
                                {
                                    short argument = Core.beakMemory.readMemory((ushort)(address + 1));
                                    string argumentHex = argument.ToString("X4");
                                    opcodeString = "C6 " + argumentHex + " add a, " + argumentHex;
                                    bytesRead = 2;
                                    break;
                                }
                            case 0x07:
                            ...
                            case 0x0B:
                                {
                                    switch (Core.beakMemory.readMemory((ushort)(address + 1)))
                                    {
                            ...
                            case 0x0D:
                                {
                                    short argument = (short)((Core.beakMemory.readMemory((ushort)(address + 1))) | (Core.beakMemory.readMemory((ushort)(address + 2)) << 8));
                                    string argumentHex = argument.ToString("X4");
                                    opcodeString = "CD " + argumentHex + " call " + argumentHex;
                                    bytesRead = 3;
                                    break;
                                }
                            case 0x0E:
                                {
                                    short argument = Core.beakMemory.readMemory((ushort)(address + 1));
                                    string argumentHex = argument.ToString("X2");
                                    opcodeString = "CE " + argumentHex + " adc a, " + argumentHex;
                                    bytesRead = 2;
                                    break;
                                }
                            case 0x0F:
                            ...
                            case 8:
                                {
                                    short argument = Core.beakMemory.readMemory((ushort)(address + 1));
                                    string argumentHex = argument.ToString("X4");
                                    opcodeString = "E8 " + argumentHex + " add sp, " + argumentHex;
                                    bytesRead = 2;
                                    break;
                                }
                            case 9:
                            ...
                            case 0xA:
                                {
                                    short argument = (short)((Core.beakMemory.readMemory((ushort)(address + 1))) | (Core.beakMemory.readMemory((ushort)(address + 2)) << 8));
                                    string argumentHex = argument.ToString("X4");
                                    opcodeString = "EA " + argumentHex + " ld (" + argumentHex + "), a";
                                    bytesRead = 3;
                                    break;
                                }
                            case 0xB:
                ...
                case 0xF0:
                    {
                        switch (opcode & 0x0F)
                        {
                            case 0:
                                {
                                    short argument = Core.beakMemory.readMemory((ushort)(address + 1));
                                    string argumentHex = argument.ToString("X4");
                                    opcodeString = "F0 " + argumentHex + " ld a, (ff00 + " + argumentHex + ")";
                                    bytesRead = 2;
                                    break;
                                }
                            case 1:
                            ...
                            case 6:
                                {
                                    short argument = Core.beakMemory.readMemory((ushort)(address + 1));
                                    string argumentHex = argument.ToString("X2");
                                    opcodeString = "F6 " + argumentHex + " or a, " + argumentHex;
                                    bytesRead = 2;
                                    break;
                                }
                            case 7:
                            ...
                            case 8:
                                {
                                    short argument = Core.beakMemory.readMemory((ushort)(address + 1));
                                    string argumentHex = argument.ToString("X4");
                                    opcodeString = "F8 " + argumentHex + " hl, sp + " + argumentHex;
                                    bytesRead = 2;
                                    break;
                                }
                            case 9:
                            ...
                            case 0xA:
                                {
                                    short argument = Core.beakMemory.readMemory((ushort)(address + 2));
                                    short argument2 = Core.beakMemory.readMemory((ushort)(address + 1));
                                    string byte1 = argument.ToString("X2");
                                    string byte2 = argument2.ToString("X2");
                            ...
                            case 0xE:
                                {
                                    short argument = Core.beakMemory.readMemory((ushort)(address + 1));
                                    string argumentHex = argument.ToString("X4");
                                    opcodeString = "FE " + argumentHex + " cp a, " + argumentHex;
                                    bytesRead = 2;
                                    break;
                                }
                            case 0xF:
