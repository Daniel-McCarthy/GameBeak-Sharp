...
namespace GameBeak.Classes
{
    class CPU
    {
        ...
        {
            //Add B to A
            int result = Core.beakMemory.getA() + Core.beakMemory.getB();

            Core.beakMemory.setHFlag((((Core.beakMemory.getA() & 0x0F) + (Core.beakMemory.getB() & 0x0F)) & 0x10) > 0);
        ...
        public void opcode81()
        {
            ...
            int result = Core.beakMemory.getA() + Core.beakMemory.getC();

            Core.beakMemory.setHFlag((((Core.beakMemory.getA() & 0x0F) + (Core.beakMemory.getC() & 0x0F)) & 0x10) > 0);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setCFlag(result > 0xFF);
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
            Core.beakMemory.setNFlag(false);
        ...
        {
            //Add D to A
            int result = Core.beakMemory.getA() + Core.beakMemory.getD();

            Core.beakMemory.setHFlag((((Core.beakMemory.getA() & 0x0F) + (Core.beakMemory.getD() & 0x0F)) & 0x10) > 0);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setCFlag(result > 0xFF);
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
            Core.beakMemory.setNFlag(false);
        ...
        {
            //Add E to A
            int result = Core.beakMemory.getA() + Core.beakMemory.getE();

            Core.beakMemory.setHFlag((((Core.beakMemory.getA() & 0x0F) + (Core.beakMemory.getE() & 0x0F)) & 0x10) > 0);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setCFlag(result > 0xFF);
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
            Core.beakMemory.setNFlag(false);
        ...
        {
            //Add H to A
            int result = Core.beakMemory.getA() + Core.beakMemory.getH();

            Core.beakMemory.setHFlag((((Core.beakMemory.getA() & 0x0F) + (Core.beakMemory.getH() & 0x0F)) & 0x10) > 0);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setCFlag(result > 0xFF);
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
            Core.beakMemory.setNFlag(false);
        ...
        {
            //Add L to A
            int result = Core.beakMemory.getA() + Core.beakMemory.getL();

            Core.beakMemory.setHFlag((((Core.beakMemory.getA() & 0x0F) + (Core.beakMemory.getL() & 0x0F)) & 0x10) > 0);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setCFlag(result > 0xFF);
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
            Core.beakMemory.setNFlag(false);
        ...
        public void opcode87()
        {
            ...
            int result = Core.beakMemory.getA() + Core.beakMemory.getA();

            Core.beakMemory.setHFlag((((Core.beakMemory.getA() & 0x0F) + (Core.beakMemory.getA() & 0x0F)) & 0x10) > 0);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setCFlag(result > 0xFF);
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
            Core.beakMemory.setNFlag(false);
        ...
        public void opcode88()
        {
            ...
            int result = Core.beakMemory.getA() + Core.beakMemory.getB() + carry;

            Core.beakMemory.setHFlag((((Core.beakMemory.getA() & 0x0F) + (Core.beakMemory.getB() & 0x0F) + carry) & 0x10) > 0);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setCFlag(result > 0xFF);
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
            Core.beakMemory.setNFlag(false);
        ...
        public void opcode89()
        {
            ...
            int carry = (Core.beakMemory.getCFlag() ? 1 : 0);
            int result = Core.beakMemory.getA() + Core.beakMemory.getC() + carry;

            Core.beakMemory.setHFlag((((Core.beakMemory.getA() & 0x0F) + (Core.beakMemory.getC() & 0x0F) + carry) & 0x10) > 0);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setCFlag(result > 0xFF);
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
            Core.beakMemory.setNFlag(false);
        ...
        public void opcode8A()
        {
            ...
            int carry = (Core.beakMemory.getCFlag() ? 1 : 0);
            int result = Core.beakMemory.getA() + Core.beakMemory.getD() + carry;

            Core.beakMemory.setHFlag((((Core.beakMemory.getA() & 0x0F) + (Core.beakMemory.getD() & 0x0F) + carry) & 0x10) > 0);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setCFlag(result > 0xFF);
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
            Core.beakMemory.setNFlag(false);
        ...
        public void opcode8B()
        {
            ...
            int carry = (Core.beakMemory.getCFlag() ? 1 : 0);
            int result = Core.beakMemory.getA() + Core.beakMemory.getE() + carry;

            Core.beakMemory.setHFlag((((Core.beakMemory.getA() & 0x0F) + (Core.beakMemory.getE() & 0x0F) + carry) & 0x10) > 0);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setCFlag(result > 0xFF);
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
            Core.beakMemory.setNFlag(false);
        ...
        public void opcode8C()
        {
            ...
            int carry = (Core.beakMemory.getCFlag() ? 1 : 0);
            int result = Core.beakMemory.getA() + Core.beakMemory.getH() + carry;

            Core.beakMemory.setHFlag((((Core.beakMemory.getA() & 0x0F) + (Core.beakMemory.getH() & 0x0F) + carry) & 0x10) > 0);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setCFlag(result > 0xFF);
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
            Core.beakMemory.setNFlag(false);
        ...
        public void opcode8D()
        {
            ...
            int carry = (Core.beakMemory.getCFlag() ? 1 : 0);
            int result = Core.beakMemory.getA() + Core.beakMemory.getL() + carry;

            Core.beakMemory.setHFlag((((Core.beakMemory.getA() & 0x0F) + (Core.beakMemory.getL() & 0x0F) + carry) & 0x10) > 0);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setCFlag(result > 0xFF);
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
            Core.beakMemory.setNFlag(false);
        ...
        public void opcode8F()
        {
            ...
            int carry = (Core.beakMemory.getCFlag() ? 1 : 0);
            int result = Core.beakMemory.getA() + Core.beakMemory.getA() + carry;

            Core.beakMemory.setHFlag((((Core.beakMemory.getA() & 0x0F) + (Core.beakMemory.getA() & 0x0F) + carry) & 0x10) > 0);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setCFlag(result > 0xFF);
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
            Core.beakMemory.setNFlag(false);
        ...
        public void opcode98()
        {
            ...
            Core.beakMemory.setCFlag((Core.beakMemory.getB() + carry) > Core.beakMemory.getA()); //(n > a)//Core.beakMemory.setCFlag(result < 0xFF);
            Core.beakMemory.setHFlag((((Core.beakMemory.getB() & 0x0F) + carry)) > (Core.beakMemory.getA() & 0x0F));
            Core.beakMemory.setNFlag(true);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
        ...
        public void opcode99()
        {
            ...
            Core.beakMemory.setCFlag((Core.beakMemory.getC() + carry) > Core.beakMemory.getA()); //(n > a)//Core.beakMemory.setCFlag(result < 0xFF);
            Core.beakMemory.setHFlag((((Core.beakMemory.getC() & 0x0F) + carry)) > (Core.beakMemory.getA() & 0x0F));
            Core.beakMemory.setNFlag(true);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
        ...
        public void opcode9A()
        {
            ...
            Core.beakMemory.setCFlag((Core.beakMemory.getD() + carry) > Core.beakMemory.getA()); //(n > a)//Core.beakMemory.setCFlag(result < 0xFF);
            Core.beakMemory.setHFlag((((Core.beakMemory.getD() & 0x0F) + carry)) > (Core.beakMemory.getA() & 0x0F));
            Core.beakMemory.setNFlag(true);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
        ...
        public void opcode9B()
        {
            ...
            Core.beakMemory.setCFlag((Core.beakMemory.getE() + carry) > Core.beakMemory.getA()); //(n > a)//Core.beakMemory.setCFlag(result < 0xFF);
            Core.beakMemory.setHFlag((((Core.beakMemory.getE() & 0x0F) + carry)) > (Core.beakMemory.getA() & 0x0F));
            Core.beakMemory.setNFlag(true);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
        ...
        public void opcode9C()
        {
            ...
            Core.beakMemory.setCFlag((Core.beakMemory.getH() + carry) > Core.beakMemory.getA()); //(n > a)//Core.beakMemory.setCFlag(result < 0xFF);
            Core.beakMemory.setHFlag((((Core.beakMemory.getH() & 0x0F) + carry)) > (Core.beakMemory.getA() & 0x0F));
            Core.beakMemory.setNFlag(true);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
        ...
        public void opcode9D()
        {
            ...
            Core.beakMemory.setCFlag((Core.beakMemory.getL() + carry) > Core.beakMemory.getA()); //(n > a)//Core.beakMemory.setCFlag(result < 0xFF);
            Core.beakMemory.setHFlag((((Core.beakMemory.getL() & 0x0F) + carry)) > (Core.beakMemory.getA() & 0x0F));
            Core.beakMemory.setNFlag(true);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
        ...
        public void opcode9E()
        {
            ...
            Core.beakMemory.setCFlag((data + carry) > Core.beakMemory.getA()); //(n > a)//Core.beakMemory.setCFlag(result < 0xFF);
            Core.beakMemory.setHFlag((((data & 0x0F) + carry)) > (Core.beakMemory.getA() & 0x0F));
            Core.beakMemory.setNFlag(true);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
        ...
        public void opcode9F()
        {
            ...
            Core.beakMemory.setCFlag((Core.beakMemory.getA() + carry) > Core.beakMemory.getA()); //(n > a)//Core.beakMemory.setCFlag(result < 0xFF);
            Core.beakMemory.setHFlag((((Core.beakMemory.getA() & 0x0F) + carry)) > (Core.beakMemory.getA() & 0x0F));
            Core.beakMemory.setNFlag(true);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
        ...
        public void opcodeC6(byte n)
        {
            ...
            int result = Core.beakMemory.getA() + n;

            Core.beakMemory.setHFlag((((Core.beakMemory.getA() & 0x0F) + (n & 0x0F)) & 0x10) > 0);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setCFlag(result > 0xFF);
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
            Core.beakMemory.setNFlag(false);
        ...
        public void opcodeDE(byte n)
        {
            ...
            Core.beakMemory.setCFlag((n + carry) > Core.beakMemory.getA());
            Core.beakMemory.setHFlag((((n & 0x0F) + carry)) > (Core.beakMemory.getA() & 0x0F));
            Core.beakMemory.setNFlag(true);
            Core.beakMemory.setA((byte)(result & 0xFF));
            Core.beakMemory.setZFlag(Core.beakMemory.getA() == 0);
